...
def test_from_pairs():
    ...
    expects = (
        UnicodeDataEntry(1, 2, "A"),
        UnicodeDataEntry(3, 4, "B"),
        UnicodeDataEntry(6, 6, "C"),
        UnicodeDataEntry(8, 9, "C"),
...
def test_from_pairs_none():
    ...
    entries = tuple(entries)
    expects = (
        UnicodeDataEntry(1, 1, None),
        UnicodeDataEntry(2, 3, "A"),
        UnicodeDataEntry(5, 5, None),
        UnicodeDataEntry(7, 7, "A"),
...
def test_from_values_none():
    ...
    entries = tuple(entries)
    expects = (
        UnicodeDataEntry(1, 1, "A"),
        UnicodeDataEntry(3, 3, "A"),
